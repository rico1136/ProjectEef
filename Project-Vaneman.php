	...
	<div class="section sec-3" style="margin-top: 4em;">
		<div class="container">
			...
			<div class="row mb-5 justify-content-between">
				...
				<div class="col-lg-5">
					<div class="heading">Customized by Vaneman</div>
				</div>
			</div>
				...
				<div class="testimonial-slide-center-wrap" data-aos="fade-up" data-aos-delay="100">
					...
					<div class="testimonial-slide-center testimonial-center" id="testimonial-center">
						...
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Vaneman/1.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Vaneman/3.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Vaneman/4.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Vaneman/5.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Vaneman/7.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Vaneman/6.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Opdrachtgever:</span> Customized by Vaneman
				</div>
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Begin:</span> 01 Jun 2021
				</div>
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Eind:</span> 01 Dec 2021
				</div>
			</div>
		</div>
	</div>
