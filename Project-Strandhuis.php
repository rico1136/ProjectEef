...
<head>
	...
	<title>Project Eef &mdash; Project</title>
</head>
<body>
...
<nav class="site-nav"	style="background-color: #c6c6c6;"
>
	<div class="container">
	...
	<!-- <div class="hero-2" style="background-color: rgb(227, 227, 227);">
		<div class="container">
	...
	<div class="section sec-3" style="margin-top: 4em;">
		<div class="container">
			...
			<div class="row mb-5 justify-content-between">
				...
				<div class="col-lg-5">
					<div class="heading">Cadzand at See</div>
				</div>
			</div>
				...
				<div class="testimonial-slide-center-wrap" data-aos="fade-up" data-aos-delay="100">
					...
					<div class="testimonial-slide-center testimonial-center" id="testimonial-center">
						...
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Strandhuis/keuken 2.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Strandhuis/woonkamer 1.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Strandhuis/woonkamer 2.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Strandhuis/slaapkamer 1.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						...
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Strandhuis/badkamer 1.1.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Strandhuis/badkamer 1.2.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Strandhuis/slaapkamer 2.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Strandhuis/badkamer 2.1.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/Strandhuis/badkamer 2.2.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Project Jaar:</span>  2021
				</div>
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Opdrachtgever:</span> Cadzand at Sea
				</div>
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Begin:</span> 01 Sep 2021
				</div>
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Eind:</span> 01 Nov 2021
				</div>
			</div>
		</div>
	</div>
