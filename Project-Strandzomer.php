		...
		<div class="container">
				...
				<div class="testimonial-slide-center-wrap" data-aos="fade-up" data-aos-delay="100">
					...
					<div class="testimonial-slide-center testimonial-center" id="testimonial-center">
						...
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/StrandZomer/Strandzomer1.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial-item">
								<div  class="testimonial-item-inner" >
									<img src="images/StrandZomer/Strandzomer3.png" alt="Image" class="img-fluid">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Project Jaar:</span>  2020
				</div>
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Opdrachtgever:</span> Strandzomer
				</div>
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Begin:</span> 01 Feb 2020
				</div>
				<div class="col-sm-3 border-left">
					<span class="text-black-50 d-block">Eind:</span> 01 Jun 2020
				</div>
			</div>
		</div>
	</div>
